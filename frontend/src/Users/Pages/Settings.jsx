...
const Settings = () => {
  ...
  return (
    <div className="w-full font-roboto bg-[#01071C] h-screen">
      <DefaultLayout>
        <div className="grid grid-cols-12 gap-4 shadow-md shadow-[#272f4f] px-10 py-10 mt-10 rounded-md bg-[#01071C] md:mt-6 md:gap-6 2xl:mt-[1.875rem] 2xl:gap-[1.875rem]">
            ...
            <div className="py-10">
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex justify-end gap-4 mt-6">
                  <button
                    type="button"
                    className="bg-[#ffb400] text-white p-2 rounded-md w-full"
                  >
                    Cancel
                  </button>
                  <button
